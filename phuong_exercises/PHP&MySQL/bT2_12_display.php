...
<body>
    ...
    if ($result->num_rows > 0) {
        echo "<h3 colspan='8' style='text-align: center; color: black; font-size: 30px'><b>THÔNG TIN KHÁCH HÀNG</b></h3>";
        echo "<table border='1'>";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td><a href='bT2_12_edit.php?id=" . $row["Ma_khach_hang"] . "'>Chỉnh Sửa</a></td>"; 
            echo "<td><a href='bT2_12_delete.php?id=" . $row["Ma_khach_hang"] . "'>Xóa</a></td>";
            echo "</tr>";
        }
