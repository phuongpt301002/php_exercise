...
<body>
  ...
  echo "<tr><td colspan='2'<b style='text-align: center; color: coral; font-weight: bold; font-size: 30px'>THÔNG TIN CÁC SẢN PHẨM</b></td></tr>";
  if (mysqli_num_rows($result) <> 0) {
      while ($rows = mysqli_fetch_row($result)) {
          echo "<tr>
          <td width='50%' height='200px' align='center'><img width='150px' src='./Anhdata1/$rows[0]' alt=''></td>
          <td>
              <b>$rows[1]</b>
