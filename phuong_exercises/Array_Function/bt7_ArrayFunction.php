...
<body>
    <?php
        if(isset($_POST['submit'])){
            ...
            $hinh = $mang_hinh[$chi];
            $hinh_anh = "<img src='Anh_bt7/$hinh'  width='200' alt='Hình con vật' >";
        }
    ?>
    <form action="" name="lunarYear" method="post">
        <table align="center" style="background-color: #E6E6FA;">
            ...
            <tr>
                ...
                <td></td>
                <td style="text-align: center; color: blue">Năm âm lịch</td>
            </tr>
            <tr>
                <td align="center">
                ...
                <td align="center">
                    <input style="color: red; font-weight: bold;" type="text" name="lunarYear" readonly value="<?php
