...
<?php
    if(isset($_POST['submit'])){
        ...
        if(is_numeric($number1) && is_numeric($number2)){
            ...
            $msg = "Số thứ nhất hoặc số thứ hai không hợp lệ vui lòng nhập lại";
            $ketqua = "NOT VALUE";
            header("Location: ". $_SERVER['HTTP_REFERER']);
            exit();
        }
...
<form action="result_bt7.php" method="post">
        <table style="background: #dff9fb;">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="number1" size="20" value="<?php
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="number2" size="20" value="<?php
