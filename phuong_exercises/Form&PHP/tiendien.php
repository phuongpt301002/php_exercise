    ...
    <form method="post" name="tiendien">
        <table style="background: beige;">
            ...
            <tr>
                <td>Đơn giá</td>
                <td>
                    <input type="text" name="dongia" size="20" value="<?php
                    if(isset($dongia)) echo $dongia;
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="money" size="20" readonly style="background: pink"
                    value="<?php
                    if(isset($money)) echo $money;
